...
export const A11Y_LAST_FOCUS_REACHED_EVENT = A11Y_EVENT + ":" + FOCUS_EVENT + ":lastElementReached"; // Dropdown events
...
export const DROPDOWN_LAST_FOCUS_REACHED_EVENT = DROPDOWN_EVENT + ":" + FOCUS_EVENT + ":lastElementReached"; // DashboardLayout events
...
export const dispatchEvent = (eventName, detail) => function (root) {
  if (root === void 0) {
    root = window;
  }
