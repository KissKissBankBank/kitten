...
export const getFocusableElementsFrom = root => [...root.querySelectorAll(focusableElements)].filter(el => isVisible(el));
export const keyboardNavigation = function (elements, _temp) {
  let {
    events = {
