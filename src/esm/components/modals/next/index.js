...
import { CONTAINER_PADDING, CONTAINER_PADDING_MOBILE, GUTTER, CONTAINER_MAX_WIDTH } from '../../../constants/grid-config';
...
var InnerModal = function InnerModal(_ref5) {
  var trigger = _ref5.trigger,
      ...
      others = _objectWithoutProperties(_ref5, ["trigger", "children", "label", "labelledby", "describedby", "className", "closeButtonLabel", "onClose", "modalProps", "hasCloseButton", "maxWidth", "size", "isOpen", "zIndex", "fullSize", "fullSizeTitle", "variant", "headerTitle", "headerActions"]);
