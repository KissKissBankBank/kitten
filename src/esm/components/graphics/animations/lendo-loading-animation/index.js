...
var ola = keyframes(["0%{transform:translateY(0);}60%{transform:translateY(0);}68%{transform:translateY(0.8px);}95%{transform:translateY(-3px);}100%{transform:translateY(-3px);}"]);
var StyledLoadingAnimation = styled.svg.withConfig({
...
export var LendoLoadingAnimation = function LendoLoadingAnimation(props) {
