...
const ola = keyframes(["0%{transform:translateY(0);}60%{transform:translateY(0);}68%{transform:translateY(0.8px);}95%{transform:translateY(-3px);}100%{transform:translateY(-3px);}"]);
const StyledLoadingAnimation = styled.svg.withConfig({
...
export const LendoLoadingAnimation = props => /*#__PURE__*/React.createElement(StyledLoadingAnimation, _extends({
  viewBox: "0 0 28 28",
