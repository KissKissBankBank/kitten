...
export var SMALL = css(["--Button-min-width:", ";min-width:", ";min-height:", ";padding:", " ", ";font-size:", ";"], pxToRem(160), pxToRem(160), pxToRem(40), pxToRem(7), pxToRem(20), stepToRem(-1));
...
export var ICON_SMALL = css(["width:", ";height:", ";"], pxToRem(40), pxToRem(40));
