...
var Expandable = function Expandable(_ref4) {
  var className = _ref4.className,
      ...
      icon = _ref4.icon,
      title = _ref4.title,
      props = _objectWithoutProperties(_ref4, ["className", "children", "icon", "title"]);
...
var Selector = function Selector(_ref6) {
  ...
  if (data.length === 1) {
    ...
    return /*#__PURE__*/React.createElement("div", _extends({}, dataProps, {
      className: classNames('k-DashboardMenu__selectorButton', dataProps.className, className)
    }), !!icon && /*#__PURE__*/React.createElement("span", {
      className: "k-DashboardMenu__iconWrapper"
    }, icon), /*#__PURE__*/React.createElement("span", {
