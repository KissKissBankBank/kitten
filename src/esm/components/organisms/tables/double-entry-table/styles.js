...
}, pxToRem(68), pxToRem(20), stepToRem(-1), pxToRem(120), TYPOGRAPHY.fontStyles.light, TYPOGRAPHY.fontStyles.regular, COLORS.background1, pxToRem(ScreenConfig.M.min), function (_ref2) {
  var firstColWidth = _ref2.firstColWidth;
  return pxToRem(firstColWidth);
}, TYPOGRAPHY.fontStyles.bold, pxToRem(135), COLORS.background2, pxToRem(ScreenConfig.M.min), function (_ref3) {
