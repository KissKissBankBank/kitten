...
export var CounterBlock = function CounterBlock(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Container, null, isString(title) ? /*#__PURE__*/React.createElement(Marger, {
    ...
    size: "huge",
    tag: subTitleTag
  }, _defineProperty(_React$createElement, "tag", "p"), _defineProperty(_React$createElement, "fontStyle", "italic"), _defineProperty(_React$createElement, "weight", "light"), _React$createElement), subTitle)) : subTitle);
};
