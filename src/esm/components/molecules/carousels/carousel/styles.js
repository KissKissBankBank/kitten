...
export var StyledCarouselContainer = styled.div.withConfig({
  ...
  return pxToRem(baseItemMarginBetween - OUTLINE_PLUS_OFFSET * 2);
}, pxToRem(OUTLINE_PLUS_OFFSET), function (_ref13) {
