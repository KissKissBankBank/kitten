...
}, pxToRem(CONTAINER_PADDING_THIN / 2), function (_ref6) {
...
}, pxToRem(CONTAINER_PADDING_THIN / 2 - OUTLINE_PLUS_OFFSET * 2), pxToRem(ScreenConfig.S.min), pxToRem(CONTAINER_PADDING / 2 - OUTLINE_PLUS_OFFSET * 2), pxToRem(ScreenConfig.L.min), function (_ref12) {
  var baseItemMarginBetween = _ref12.baseItemMarginBetween;
  return pxToRem(baseItemMarginBetween - OUTLINE_PLUS_OFFSET * 2);
}, pxToRem(OUTLINE_PLUS_OFFSET), COLORS.primary4, pxToRem(2), pxToRem(2), COLORS.primary4, function (_ref13) {
  var numberOfItemsPerPage = _ref13.numberOfItemsPerPage;
  return numberOfItemsPerPage > 1 ? css(["(1fr ", ")[", "] 1fr;"], pxToRem(CONTAINER_PADDING_THIN / 2), numberOfItemsPerPage - 1) : '1fr';
