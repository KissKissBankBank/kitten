...
export var TagButton = function TagButton(_ref) {
  var children = _ref.children,
      ...
      others = _objectWithoutProperties(_ref, ["children", "modifier", "selected", "tiny", "big", "huge", "icon", "className"]);

  return /*#__PURE__*/React.createElement(StyledTagButton, _extends({
    className: classNames('k-Buttons__tagButton', className, "k-Buttons__tagButton--".concat(modifier), {
