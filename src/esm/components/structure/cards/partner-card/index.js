...
export const PartnerCard = _ref => {
  ...
  return /*#__PURE__*/React.createElement(StyledCard, _extends({
    ...
    className: classNames('k-PartnerCard', className, {
