...
})(["color:currentColor;display:inline-flex;align-items:center;line-height:1.2;.k-StatusWithBullet__bullet{background-color:currentColor;border-radius:var(--border-radius-rounded);margin-top:", ";flex:0 0 auto;}.k-StatusWithBullet__status{flex:0 1 auto;}&.k-StatusWithBullet--danger{color:", ";}&.k-StatusWithBullet--success{color:", ";}&.k-StatusWithBullet--warning{color:", ";}&.k-StatusWithBullet--neutral{color:", ";}&.k-StatusWithBullet--normal{font-size:", ";.k-StatusWithBullet__bullet{width:", ";height:", ";margin-right:", ";}}&.k-StatusWithBullet--tiny{font-size:", ";.k-StatusWithBullet__bullet{width:", ";height:", ";margin-right:", ";}}&.k-StatusWithBullet--micro{font-size:", ";.k-StatusWithBullet__bullet{width:", ";height:", ";margin-right:", ";}}&.k-StatusWithBullet--light{", "}&.k-StatusWithBullet--regular{", "}&.k-StatusWithBullet--bold{", "}"], pxToRem(2), COLORS.error, COLORS.valid, COLORS.orange, COLORS.primary1, stepToRem(0), pxToRem(12), pxToRem(12), pxToRem(11), stepToRem(-1), pxToRem(10), pxToRem(10), pxToRem(10), stepToRem(-2), pxToRem(7), pxToRem(7), pxToRem(8), TYPOGRAPHY.fontStyles.light, TYPOGRAPHY.fontStyles.regular, TYPOGRAPHY.fontStyles.bold);
