...
})(["display:flex;height:", ";line-height:1;gap:", ";.k-Loader__circle{width:", ";height:", ";border-radius:", ";animation:k-Loader-animation-scale 1.75s 0s infinite cubic-bezier(0.2,0.68,0.18,1.08);animation-fill-mode:both;&:nth-child(1){animation-delay:calc(-1.75s / 3);}&:nth-child(2){animation-delay:calc(-1.75s / 3 / 2);}&:nth-child(3){animation-delay:0s;}}&.k-Loader--noGap .k-Loader__circle:not(:last-child){margin-right:", ";}@keyframes k-Loader-animation-scale{0%{transform:scale(1);}45%{transform:scale(0.1);fill:transparent;}80%{transform:scale(1);}}"], pxToRem(BULLET_SIZE), pxToRem(2), pxToRem(BULLET_SIZE), pxToRem(BULLET_SIZE), pxToRem(BULLET_SIZE), pxToRem(2));
