...
import ColorsConfig from '../../../constants/colors-config'; // STYLE HELPERS
...
}, pxToRem(CONTAINER_PADDING_MOBILE), pxToRem(CONTAINER_PADDING_MOBILE), pxToRem(ScreenConfig.S.min), pxToRem(CONTAINER_PADDING), pxToRem(CONTAINER_PADDING), pxToRem(CONTAINER_PADDING_MOBILE), pxToRem(ScreenConfig.S.min), pxToRem(CONTAINER_PADDING), function (_ref11) {
  var numberOfItemsPerPage = _ref11.numberOfItemsPerPage;
  return numberOfItemsPerPage;
}, pxToRem(CONTAINER_PADDING_MOBILE / 2), pxToRem(ScreenConfig.S.min), pxToRem(CONTAINER_PADDING / 2), pxToRem(ScreenConfig.L.min), function (_ref12) {
