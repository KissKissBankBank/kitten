...
export var StyledCarouselContainer = styled.div.withConfig({
  ...
  return pxToRem(baseItemMarginBetween);
}, pxToRem(4), ColorsConfig.primary4, pxToRem(2), pxToRem(2), function (_ref13) {
