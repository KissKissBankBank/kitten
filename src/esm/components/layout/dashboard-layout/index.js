...
export var DashboardLayout = function DashboardLayout(_ref) {
  var children = _ref.children,
      ...
      props = _objectWithoutProperties(_ref, ["children", "backLinkProps", "buttonProps", "quickAccessLinkText"]);
  ...
  return /*#__PURE__*/React.createElement(StyledDashboard, {
    ...
    children: children,
    type: Header
  })), renderComponentArray(getReactElementsByType({
    children: children,
    type: SideContent
  })), renderComponentArray(getReactElementsByType({
    children: children,
