...
export const EditorBar = _ref => {
  ...
  return /*#__PURE__*/React.createElement(StyledEditorBar, _extends({
    className: classNames('k-EditorBar', className, "k-EditorBar--theme-" + theme),
    style: { ...style,
...
EditorBar.Group = _ref2 => {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: classNames('k-EditorBar__group', className)
  }, props));
};
  ...
  return /*#__PURE__*/React.createElement(Details, _extends({
    summaryRender: _ref5 => {
      ...
      return /*#__PURE__*/React.createElement(Button, {
        ...
        fit: "icon"
      }, currentIcon, /*#__PURE__*/React.createElement(ArrowIcon, {
        width: "6",
