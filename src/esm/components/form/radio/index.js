...
export var Radio = function Radio(_ref) {
  ...
  return /*#__PURE__*/React.createElement(StyledRadio, {
    ...
    className: classNames('k-Form-Radio__labelText', "k-Form-Radio__labelText--" + fontWeight, {
