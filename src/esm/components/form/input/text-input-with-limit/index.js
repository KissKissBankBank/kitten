...
})(["position:relative;display:block;.k-Form-TextInputWithLimit__limitNumber{", ";font-size:", ";line-height:1.3;position:absolute;bottom:", ";right:", ";color:var(--color-grey-600);text-shadow:", " 0 0 var(--color-grey-000),-", " 0 0 var(--color-grey-000),0 ", " 0 var(--color-grey-000),0 -", " 0 var(--color-grey-000),", " ", " var(--color-grey-000),-", " -", " 0 var(--color-grey-000),", " -", " 0 var(--color-grey-000),-", " ", " 0 var(--color-grey-000);pointer-events:none;&.k-Form-TextInputWithLimit__limitNumber--disabled{text-shadow:none;}}&:focus + .k-Form-TextInputWithLimit__limitNumber,&:focus-within + .k-Form-TextInputWithLimit__limitNumber{color:var(--color-grey-600);}"], TYPOGRAPHY.fontStyles['500'], stepToRem(-2), pxToRem(15), pxToRem(15), pxToRem(2), pxToRem(2), pxToRem(2), pxToRem(2), pxToRem(1), pxToRem(1), pxToRem(1), pxToRem(1), pxToRem(1), pxToRem(1), pxToRem(1), pxToRem(1));
