...
}, pxToRem(15), pxToRem(4), pxToRem(4), pxToRem(4), pxToRem(4), COLORS.background1, COLORS.line1, COLORS.line2, pxToRem(40), pxToRem(50), pxToRem(60), ScreenConfig.M.min, pxToRem(70), pxToRem(70), ScreenConfig.M.min, pxToRem(80), pxToRem(70), ScreenConfig.M.min, pxToRem(90), COLORS.valid, COLORS.valid, COLORS.error, COLORS.error);
