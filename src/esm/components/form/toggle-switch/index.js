...
var StyledSwitch = styled.button.withConfig({
  ...
  return defaultColor;
}, pxToRem(borderSize), COLORS.line2, pxToRem(borderRadius), transitionDuration, transitionDuration, transitionDuration, COLORS.primary1, COLORS.primary4, pxToRem(2), pxToRem(2), COLORS.primary1, COLORS.primary4, pxToRem(borderSize), pxToRem(borderSize), pxToRem(switchHeight), pxToRem(switchHeight), COLORS.background1, pxToRem(borderSize), COLORS.line2, pxToRem(switchHeight), transitionDuration, transitionDuration, transitionDuration, transitionDuration, function (_ref4) {
