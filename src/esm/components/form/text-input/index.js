  ...
  _createClass(TextInput, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          others = _objectWithoutProperties(_this$props, ["valid", "error", "disabled", "name", "digits", "size", "center", "tag", "variant", "className", "style", "rounded", "darkBackground"]);
