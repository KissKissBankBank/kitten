...
})(["--rdp-cell-size:", ";--rdp-accent-color:var(--color-primary-500);--rdp-background-color:var(--color-grey-000);--rdp-outline:", " solid var(--rdp-accent-color);--rdp-outline-selected:", " solid rgba(0,0,0,0.75);", " .rdp-caption_label{", " font-size:", ";}.rdp-head_cell{", " font-size:", ";text-transform:capitalize;}.rdp-cell{font-size:", ";}.rdp-button{transition:color var(--transition),background-color var(--transition),border-color var(--transition);}.rdp-day_range_start,.rdp-day_range_end{", "}.rdp-day_range_middle{background-color:var(--color-primary-100);color:var(--color-primary-700);}"], pxToRem(50), pxToRem(2), pxToRem(2), TYPOGRAPHY.fontStyles[400], TYPOGRAPHY.fontStyles[500], pxToRem(14), TYPOGRAPHY.fontStyles[500], pxToRem(12), pxToRem(12), TYPOGRAPHY.fontStyles[700]);
