...
}, stepToRem(-1), stepToRem(-1), TYPOGRAPHY.fontStyles['400'], ScreenConfig.M.min, pxToRem(30), TYPOGRAPHY.fontStyles['500'], function (_ref2) {
...
}, TYPOGRAPHY.fontStyles['500'], function (_ref4) {
...
}, TYPOGRAPHY.fontStyles['400'], function (_ref13) {
...
export var StandaloneRangeDatePicker = function StandaloneRangeDatePicker(_ref14) {
  var from = _ref14.from,
      ...
      datePickerProps = _objectWithoutPropertiesLoose(_ref14, _excluded);
