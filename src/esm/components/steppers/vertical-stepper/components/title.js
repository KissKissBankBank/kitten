...
})(["margin:0;", ";font-size:", ";line-height:normal;&.k-Stepepers-VerticalStepper__title--orion{font-size:", ";font-weight:bold;}"], TYPOGRAPHY.fontStyles.regular, stepToRem(0), stepToRem(-1));
