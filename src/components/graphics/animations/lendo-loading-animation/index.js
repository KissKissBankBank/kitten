...
const ola = (0, _styledComponents.keyframes)(["0%{transform:translateY(0);}60%{transform:translateY(0);}68%{transform:translateY(0.8px);}95%{transform:translateY(-3px);}100%{transform:translateY(-3px);}"]);

const StyledLoadingAnimation = _styledComponents.default.svg.withConfig({
  displayName: "lendo-loading-animation__StyledLoadingAnimation",
  componentId: "sc-4r0q1f-0"
...
const LendoLoadingAnimation = props => /*#__PURE__*/_react.default.createElement(StyledLoadingAnimation, (0, _extends2.default)({
  viewBox: "0 0 28 28",
