...
const heartAnim = (0, _styledComponents.keyframes)(["0%{transform:translateX(0);}20%,30%{transform:translateX(", ");}50%,100%{transform:translateX(0);}"], (0, _typography.pxToRem)(7));
const circleAnim = (0, _styledComponents.keyframes)(["0%,5%{transform:rotate(0deg);}46%,100%{transform:rotate(360deg);}"]);

const StyledLoadingAnimation = _styledComponents.default.div.withConfig({
...
const KissKissLoadingAnimation = _ref => {
  let {
    color,
    svgProps,
    ...props
