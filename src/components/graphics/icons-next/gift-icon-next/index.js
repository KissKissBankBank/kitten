...
var GiftIconNext = function GiftIconNext(_ref) {
...
exports.GiftIconNext = GiftIconNext;
GiftIconNext.propTypes = {
  color: _propTypes.default.string,
  secondaryColor: _propTypes.default.string,
  title: _propTypes.default.string
};
GiftIconNext.defaultProps = {
  color: '#222',
