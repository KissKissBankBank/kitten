...
exports.TINY = exports.SMALL = exports.ROUNDED = exports.NANO = exports.MICRO = exports.MEDIUM = exports.LARGE = exports.ICON_TINY = exports.ICON_SMALL = exports.ICON_NANO = exports.ICON_MICRO = exports.ICON_LARGE = exports.ICON_HUGE = exports.ICON_GIANT = exports.ICON_BIG = exports.ICON = exports.HUGE = exports.GIANT = exports.FLUID = exports.DEFAULT = exports.BIG = void 0;
...
exports.FLUID = FLUID;
var ROUNDED = (0, _styledComponents.css)(["border-radius:var(--border-radius-rounded);"]); // Deprecated
...
var MEDIUM = (0, _styledComponents.css)(["--Button-min-width:", ";min-width:", ";min-height:", ";padding:", " ", ";font-size:", ";"], (0, _typography.pxToRem)(200), (0, _typography.pxToRem)(200), (0, _typography.pxToRem)(50), (0, _typography.pxToRem)(10), (0, _typography.pxToRem)(30), (0, _typography.stepToRem)(-1));
...
exports.NANO = NANO;
var MICRO = (0, _styledComponents.css)(["--Button-min-width:", ";min-width:", ";min-height:", ";padding:", " ", ";font-size:", ";"], (0, _typography.pxToRem)(130), (0, _typography.pxToRem)(130), (0, _typography.pxToRem)(30), (0, _typography.pxToRem)(5), (0, _typography.pxToRem)(10), (0, _typography.stepToRem)(-2)); // Deprecated
...
exports.TINY = TINY;
var SMALL = (0, _styledComponents.css)(["--Button-min-width:", ";min-width:", ";min-height:", ";padding:", " ", ";font-size:", ";"], (0, _typography.pxToRem)(160), (0, _typography.pxToRem)(160), (0, _typography.pxToRem)(40), (0, _typography.pxToRem)(7), (0, _typography.pxToRem)(20), (0, _typography.stepToRem)(-1)); // Deprecated
...
exports.BIG = BIG;
var LARGE = (0, _styledComponents.css)(["@media (min-width:", "){--Button-min-width:", ";min-width:", ";min-height:", ";padding:", " ", ";font-size:", ";}"], (0, _typography.pxToRem)(_screenConfig.ScreenConfig.S.min), (0, _typography.pxToRem)(220), (0, _typography.pxToRem)(220), (0, _typography.pxToRem)(70), (0, _typography.pxToRem)(10), (0, _typography.pxToRem)(40), (0, _typography.stepToRem)(0));
exports.LARGE = LARGE;
...
var ICON_MICRO = (0, _styledComponents.css)(["width:", ";height:", ";"], (0, _typography.pxToRem)(30), (0, _typography.pxToRem)(30)); // Deprecated
...
var ICON_SMALL = (0, _styledComponents.css)(["width:", ";height:", ";"], (0, _typography.pxToRem)(40), (0, _typography.pxToRem)(40)); // Deprecated
...
var ICON_LARGE = (0, _styledComponents.css)(["@media (min-width:", "){--Button-min-width:0;min-width:0;min-height:0;padding:0;width:", ";height:", ";}"], (0, _typography.pxToRem)(_screenConfig.ScreenConfig.S.min), (0, _typography.pxToRem)(70), (0, _typography.pxToRem)(70));
