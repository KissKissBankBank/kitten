...
const zoomInAndOpacity = (0, _styledComponents.keyframes)(["from{transform:translateX(var(--ButtonWithTooltip-translate)) translateY(0) scale(.66);opacity:0;}to{transform:translateX(var(--ButtonWithTooltip-translate)) translateY(", ") scale(1);opacity:1;}"], (0, _typography.pxToRem)(ARROW_SIZE));

const StyledButtonWithTooltip = _styledComponents.default.div.withConfig({
