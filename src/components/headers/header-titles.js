...
function (_React$Component) {
  ...
  function HeaderTitles() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(HeaderTitles).apply(this, arguments));
  }
  ...
  _createClass(HeaderTitles, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_header.HeaderItem, _extends({
