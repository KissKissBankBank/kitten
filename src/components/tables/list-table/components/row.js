...
})(["&:hover{cursor:pointer;background:", ";}border-bottom:2px solid ", ";", ""], _colorsConfig.default.background2, _colorsConfig.default.line1, function (_ref) {
  var isHighlighted = _ref.isHighlighted;
  return isHighlighted && (0, _styledComponents.css)(["background:", ";&:hover{background:", ";}"], _colorsConfig.default.primary6, _colorsConfig.default.primary5);
});
...
var ListTableRow = function ListTableRow(_ref2) {
  var isHighlighted = _ref2.isHighlighted,
      ...
      others = (0, _objectWithoutProperties2.default)(_ref2, ["isHighlighted", "children"]);
  return _react.default.createElement(StyledRow, {
    isHighlighted: isHighlighted
  }, _react.default.createElement(StyledItemList, others, _react.default.createElement(_context.Context.Consumer, null, function (_ref3) {
    var id = _ref3.id;
