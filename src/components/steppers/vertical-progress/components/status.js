...
var _hourglassIcon = require("../../../../components/icons/hourglass-icon");
...
})(["display:flex;flex:1;&.k-VerticalProgress__status--actions{.k-VerticalProgress__icon{background-color:", ";border-color:", ";}.k-VerticalProgress__title{color:", ";}}&.k-VerticalProgress__status--waiting{.k-VerticalProgress__icon{background-color:", ";border-color:", ";}.k-VerticalProgress__title{color:", ";}}&.k-VerticalProgress__status--publish{.k-VerticalProgress__icon{background-color:", ";border-color:", ";}.k-VerticalProgress__title{color:", ";}}&.k-VerticalProgress__status--valid{.k-VerticalProgress__icon{background-color:", ";border-color:", ";}.k-VerticalProgress__title{color:", ";}}&.k-VerticalProgress__status--disabled{.k-VerticalProgress__icon{border-color:", ";background-color:", ";}.k-VerticalProgress__title{color:", ";}}.k-VerticalProgress__icon{flex-shrink:0;display:flex;align-items:center;justify-content:center;width:", ";height:", ";border-radius:", ";border:", " solid ", ";box-sizing:border-box;margin-right:", ";background-color:", ";}.k-VerticalProgress__title{margin:0;", ";font-size:", ";align-self:center;}"], _colorsConfig.default.orange, _colorsConfig.default.orange, _colorsConfig.default.orange, _colorsConfig.default.font3, _colorsConfig.default.font3, _colorsConfig.default.font3, _colorsConfig.default.line3, _colorsConfig.default.line3, _colorsConfig.default.line3, _colorsConfig.default.primary1, _colorsConfig.default.primary1, _colorsConfig.default.primary1, _colorsConfig.default.line1, _colorsConfig.default.background1, _colorsConfig.default.font2, (0, _typography.pxToRem)(STATUS_SIZE), (0, _typography.pxToRem)(STATUS_SIZE), (0, _typography.pxToRem)(STATUS_SIZE), (0, _typography.pxToRem)(2), _colorsConfig.default.background1, (0, _typography.pxToRem)(20), _colorsConfig.default.background1, _typographyConfig.default.fontStyles.bold, (0, _typography.stepToRem)(1));
