...
/*#__PURE__*/
function (_Component) {
  _inherits(HorizontalStroke, _Component);

  function HorizontalStroke() {
    _classCallCheck(this, HorizontalStroke);

    return _possibleConstructorReturn(this, _getPrototypeOf(HorizontalStroke).apply(this, arguments));
  }

  _createClass(HorizontalStroke, [{
    key: "render",
