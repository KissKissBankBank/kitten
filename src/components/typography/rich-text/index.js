...
const RichText = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement(StyledRichText, (0, _extends2.default)({
    className: (0, _classnames.default)('k-RichText', className, "k-RichText--" + size)
  }, props));
};
