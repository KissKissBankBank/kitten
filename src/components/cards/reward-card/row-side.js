...
/*#__PURE__*/
function (_Component) {
  _inherits(RewardCardRowSideBase, _Component);

  function RewardCardRowSideBase() {
    _classCallCheck(this, RewardCardRowSideBase);

    return _possibleConstructorReturn(this, _getPrototypeOf(RewardCardRowSideBase).apply(this, arguments));
  }

  _createClass(RewardCardRowSideBase, [{
    key: "render",
...
_defineProperty(RewardCardRowSideBase, "propTypes", {
  withVerticalMargins: _propTypes.default.bool,
  children: _propTypes.default.node
});

_defineProperty(RewardCardRowSideBase, "defaultProps", {
