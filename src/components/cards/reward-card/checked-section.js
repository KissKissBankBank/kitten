...
/*#__PURE__*/
function (_Component) {
  _inherits(RewardCardCheckedSection, _Component);

  function RewardCardCheckedSection() {
    _classCallCheck(this, RewardCardCheckedSection);

    return _possibleConstructorReturn(this, _getPrototypeOf(RewardCardCheckedSection).apply(this, arguments));
  }

  _createClass(RewardCardCheckedSection, [{
    key: "render",
...
_defineProperty(RewardCardCheckedSection, "propTypes", {
