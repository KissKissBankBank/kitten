...
/*#__PURE__*/
function (_Component) {
  _inherits(RewardCardCheckedIconLine, _Component);

  function RewardCardCheckedIconLine() {
    _classCallCheck(this, RewardCardCheckedIconLine);

    return _possibleConstructorReturn(this, _getPrototypeOf(RewardCardCheckedIconLine).apply(this, arguments));
  }

  _createClass(RewardCardCheckedIconLine, [{
    key: "render",
