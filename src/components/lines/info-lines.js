...
/*#__PURE__*/
function (_Component) {
  _inherits(InfoLines, _Component);
  ...
  function InfoLines(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(InfoLines).call(this, props));
  ...
  _createClass(InfoLines, [{
    ...
    value: function renderInfo(element) {
      var key = element.key,
          ...
          style = element.style,
          others = _objectWithoutProperties(element, ["key", "value", "id", "className", "style"]);

      var infoClassName = (0, _classnames.default)('k-InfoLines__line', className);

      var infoStyle = _objectSpread({}, style, {
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          others = _objectWithoutProperties(_this$props, ["borderColor", "className", "infos", "withBorderRadius", "withLeftRightBorder", "withoutResponsive", "withoutTopBottomBorder", "style"]);
      ...
      var infoLinesStyle = _objectSpread({}, style, {
