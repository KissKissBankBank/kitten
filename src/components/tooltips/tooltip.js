  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          id = _this$props.id,
          buttonQuestionMarkIconProps = _objectWithoutProperties(_this$props, ["place", "children", "id"]);

      return _react.default.createElement("div", {
        className: "k-Tooltip"
      }, _react.default.createElement(_buttonQuestionMarkIcon.ButtonQuestionMarkIcon, _extends({
        "data-tip": true,
        "data-for": id,
        "data-event": "click",
        "data-dismiss": id,
