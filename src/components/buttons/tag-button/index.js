...
var TagButton = function TagButton(_ref) {
  var children = _ref.children,
      ...
      others = (0, _objectWithoutProperties2.default)(_ref, ["children", "modifier", "selected", "tiny", "big", "huge", "icon", "className"]);
  return /*#__PURE__*/_react.default.createElement(StyledTagButton, (0, _extends2.default)({
    className: (0, _classnames.default)('k-Buttons__tagButton', className, "k-Buttons__tagButton--".concat(modifier), {
