...
const StyledDev = _styledComponents.default.div.withConfig({
...
const DevGrid = _ref => {
  ...
  const [isVisible, setVisibility] = (0, _react.useState)(visible);
  (0, _react.useEffect)(() => {
  ...
  }, Array(_gridConfig.NUM_COLUMNS).fill(0).map((el, item) => /*#__PURE__*/_react.default.createElement("div", {
