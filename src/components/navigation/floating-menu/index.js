...
})(["box-shadow:var(--box-shadow-m);display:flex;flex-direction:column;gap:", ";background-color:var(--color-grey-000);overflow:hidden;min-width:", ";border-bottom-left-radius:var(--border-radius-m);border-bottom-right-radius:var(--border-radius-m);@media ", "{border-radius:var(--border-radius-m);}.k-FloatingMenu__list{margin:0;padding:0 ", ";list-style:none;display:flex;gap:", " ", ";justify-content:space-around;flex-direction:row;overflow-x:auto;.k-FloatingMenu__item{box-sizing:border-box;height:", ";padding-bottom:", ";display:flex;align-items:center;line-height:", ";color:var(--color-grey-900);", " font-size:", ";text-decoration:none;transition:border-color var(--transition);white-space:nowrap;border-color:transparent;border-width:", " 0 0;border-style:solid;@media (max-width:", "px){font-size:", ";}&[aria-current]{", " border-color:var(--color-gray-900);}&:hover,&:active{", "}&:focus-visible{outline-style:auto;}}}&:not(.k-FloatingMenu--horizontal){@media ", "{box-shadow:var(--box-shadow-s);padding:", " 0;.k-FloatingMenu__list{padding:0;flex-direction:column;}.k-FloatingMenu__item{padding-bottom:0;padding-left:", ";border-width:0 0 0 ", ";}}}"], (0, _typography.pxToRem)(30), (0, _typography.pxToRem)(185), _screenConfig.mq.desktop, (0, _typography.pxToRem)(10), (0, _typography.pxToRem)(2), (0, _typography.pxToRem)(10), (0, _typography.pxToRem)(50), (0, _typography.pxToRem)(4), (0, _typography.pxToRem)(20), _typographyConfig.default.fontStyles.light, (0, _typography.pxToRem)(16), (0, _typography.pxToRem)(4), _screenConfig.ScreenConfig.XXS.max, (0, _typography.pxToRem)(14), _typographyConfig.default.fontStyles.bold, _typographyConfig.default.fontStyles.bold, _screenConfig.mq.desktop, (0, _typography.pxToRem)(10), (0, _typography.pxToRem)(16), (0, _typography.pxToRem)(4));
