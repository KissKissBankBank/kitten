...
})(["{input[type='file']{border:0;clip-path:inset(100%);height:1px;overflow:hidden;padding:0;position:absolute !important;white-space:nowrap;width:1px;}input[type='file']:focus + label{background-color:", ";border-color:", ";color:", ";svg,path{fill:", ";}}input[type='file']:disabled + label{border-color:", ";background-color:", ";color:", ";pointer-events:none;svg,path{fill:", ";}}.kiss-DocumentManager__uploader__button{padding:", ";}.kiss-DocumentManager__uploader__container{display:flex;justify-content:stretch;align-items:center;width:100%;}.kiss-DocumentManager__uploader__documentIcon{flex:0 0 auto;margin-right:", ";}.kiss-DocumentManager__uploader__content{flex:1 0 auto;}.kiss-DocumentManager__uploader__uploadIcon{margin-left:", ";flex:0 0 auto;}}"], _colorsConfig.default.primary2, _colorsConfig.default.primary2, _colorsConfig.default.background1, _colorsConfig.default.background1, _colorsConfig.default.line2, _colorsConfig.default.line2, _colorsConfig.default.background1, _colorsConfig.default.background1, (0, _typography.pxToRem)(20), (0, _typography.pxToRem)(20), (0, _typography.pxToRem)(20));
...
})([".kiss-DocumentManager__loading__button{min-height:", ";}"], (0, _typography.pxToRem)(100));
...
})([".kiss-DocumentManager__display__container{display:flex;justify-content:stretch;align-items:center;width:100%;}.kiss-DocumentManager__display__documentIcon{flex:0 0 auto;margin-right:", ";}.kiss-DocumentManager__display__content{flex:1 0 auto;max-height:", ";}.kiss-DocumentManager__actionButton{padding:0;border:none;font:inherit;color:inherit;background-color:transparent;margin-top:", ";cursor:pointer;transition:color 0.2s;color:", ";&:hover,&:focus{color:", ";}&:active{color:", ";transition:none;}}&.kiss-DocumentManager__display--error .kiss-DocumentManager__actionButton{color:", ";}"], (0, _typography.pxToRem)(20), (0, _typography.pxToRem)(60), (0, _typography.pxToRem)(10), _colorsConfig.default.primary1, _colorsConfig.default.primary3, _colorsConfig.default.primary1, _colorsConfig.default.error);
...
})(["position:relative;box-sizing:border-box;width:", ";height:", ";border-radius:50%;background-color:#caf4fe;padding-top:", ";padding-left:", ";&.kiss-DocumentManager__iconContainer--error{background-color:", ";}&.kiss-DocumentManager__iconContainer--valid{background-color:", ";}.kiss-DocumentManager__iconContainer__statusIcon{position:absolute;right:", ";top:", ";border:", " solid ", ";width:", ";height:", ";border-radius:50%;}"], (0, _typography.pxToRem)(60), (0, _typography.pxToRem)(60), (0, _typography.pxToRem)(15), (0, _typography.pxToRem)(19), _colorsConfig.default.error3, _colorsConfig.default.tertiary2, (0, _typography.pxToRem)(-12), (0, _typography.pxToRem)(-4), (0, _typography.pxToRem)(2), _colorsConfig.default.background1, (0, _typography.pxToRem)(20), (0, _typography.pxToRem)(20));
...
var IconContainer = function IconContainer(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(StyledIconContainer, {
    className: (0, _classnames.default)('kiss-DocumentManager__iconContainer', "kiss-DocumentManager__iconContainer--".concat(status))
  }, children, statusesWithIcons.includes(status) && /*#__PURE__*/_react.default.createElement("div", {
    className: "kiss-DocumentManager__iconContainer__statusIcon"
...
var DocumentManager = function DocumentManager(_ref2) {
  var id = _ref2.id,
      ...
      props = (0, _objectWithoutProperties2.default)(_ref2, ["id", "buttonProps", "fileInputProps", "disabled", "buttonTitle", "buttonSubtitle", "displayTitle", "displaySubtitle", "status", "onUpload", "onCancel", "canCancel", "cancelButtonText", "canReplace", "replaceButtonText", "loaderAnimation", "documentIcon"]);
  ...
  if (internalStatus === 'ready' || internalStatus === 'file-selected') {
    return /*#__PURE__*/_react.default.createElement(StyledDocumentUploader, (0, _extends2.default)({}, props, {
      className: (0, _classnames.default)('kiss-DocumentManager__uploader', props.className)
      ...
      as: "label",
      for: id,
      className: (0, _classnames.default)('kiss-DocumentManager__uploader__button', buttonProps.className)
    }), /*#__PURE__*/_react.default.createElement("div", {
      className: "kiss-DocumentManager__uploader__container"
    }, /*#__PURE__*/_react.default.createElement("div", {
      className: "kiss-DocumentManager__uploader__documentIcon"
    }, /*#__PURE__*/_react.default.createElement(IconContainer, {
      status: internalStatus
    }, documentIcon)), /*#__PURE__*/_react.default.createElement("div", {
      className: "kiss-DocumentManager__uploader__content"
      ...
      className: "kiss-DocumentManager__uploader__uploadIcon"
  ...
  if (internalStatus === 'loading') {
    return /*#__PURE__*/_react.default.createElement(StyledDocumentLoading, (0, _extends2.default)({}, props, {
      className: (0, _classnames.default)('kiss-DocumentManager__loading', props.className)
    }), /*#__PURE__*/_react.default.createElement(_button.Button, (0, _extends2.default)({
      fluid: true,
      borderRadius: 4
    }, buttonProps, {
      as: "div",
      className: (0, _classnames.default)('kiss-DocumentManager__loading__button', buttonProps.className)
    }), loaderAnimation));
  }

  return /*#__PURE__*/_react.default.createElement(StyledDocumentDisplay, (0, _extends2.default)({}, props, {
    className: (0, _classnames.default)('kiss-DocumentManager__display', "kiss-DocumentManager__display--".concat(status), props.className)
  }), /*#__PURE__*/_react.default.createElement("div", {
    className: "kiss-DocumentManager__display__container"
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "kiss-DocumentManager__display__documentIcon"
  }, /*#__PURE__*/_react.default.createElement(IconContainer, {
    status: status
  }, documentIcon)), /*#__PURE__*/_react.default.createElement("div", {
    className: "kiss-DocumentManager__display__content"
  }, /*#__PURE__*/_react.default.createElement(_text.Text, {
    tag: "p",
    weight: "regular",
    size: "tiny",
