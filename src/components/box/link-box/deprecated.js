...
DeprecatedLinkBox.propTypes = {
  ...
  textTag: (0, _deprecated.default)(_propTypes.default.string, 'Use `<Linkbox.Text />` component instead'),
  title: (0, _deprecated.default)(_propTypes.default.string.isRequired, 'Use `<Linkbox.Text />` component instead'),
  titleTag: (0, _deprecated.default)(_propTypes.default.string, 'Use `<Linkbox.Text />` component instead'),
  viewportIsMobile: (0, _deprecated.default)(_propTypes.default.bool, 'Use media query style in <Linkbox.Text /> component or child instead')
};
