...
function (_React$Component) {
  _inherits(DocLinkBox, _React$Component);

  function DocLinkBox() {
    _classCallCheck(this, DocLinkBox);

    return _possibleConstructorReturn(this, _getPrototypeOf(DocLinkBox).apply(this, arguments));
  }

  _createClass(DocLinkBox, [{
    key: "render",
    value: function render() {
      return _react.default.createElement(_linkBox.default, _extends({}, this.props, {
        displayIcon: true
