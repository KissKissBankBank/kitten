...
})(["--alert-gap:", ";@media ", "{--alert-gap:", ";}", ";margin:", ";border-radius:var(--border-radius-m);overflow:hidden;background-color:", ";color:", ";display:flex;align-items:center;gap:var(--alert-gap);padding:", " var(--alert-gap);&.k-Alert--hasCloseButton{--alert-close-width:calc(var(--alert-gap) + ", ");}&.k-Alert--hasIcon{--alert-icon-width:calc(var(--alert-gap) + ", ");}&.k-Alert--center{&.k-Alert--hasIcon:not(.k-Alert--hasCloseButton) .k-Alert__text{padding-right:var(--alert-icon-width);}&.k-Alert--hasCloseButton:not(.k-Alert--hasIcon) .k-Alert__text{padding-left:var(--alert-close-width);}&.k-Alert--hasCloseButton.k-Alert--hasIcon .k-Alert__text{padding-right:calc(var(--alert-icon-width) - var(--alert-close-width));}.k-Alert__text{text-align:center;flex-basis:auto;}}.k-Alert__text{flex:1 0 calc(100% - var(--alert-close-width,0px) - var(--alert-icon-width,0px));font-size:", ";}.k-Alert__icon{.k-Alert__iconBadge{background-color:", ";border-color:", ";min-width:", ";min-height:", ";border-radius:var(--border-radius-rounded);}}.k-Alert__closeButton{flex:0 0 ", ";transition:all 0.2s ease;display:flex;align-self:stretch;align-items:center;margin:", " calc(var(--alert-gap) * -1);padding:", " var(--alert-gap);border-top-right-radius:var(--border-radius-m);border-bottom-right-radius:var(--border-radius-m);outline-offset:", ";svg,svg path{transition:fill 0.2s ease;fill:", ";:hover{fill:", ";}}}a{", ";color:", ";text-decoration:underline;}&.k-Alert--success{background-color:", ";[href]{color:", ";}.k-Alert__iconBadge{background-color:", ";border-color:", ";}.k-Alert__closeButton{svg,svg path{fill:", ";:hover{fill:", ";}}}}&.k-Alert--error{background-color:", ";[href]{color:", ";}.k-Alert__iconBadge{background-color:", ";border-color:", ";}.k-Alert__closeButton{svg,svg path{fill:", ";:hover{fill:", ";}}}}&.k-Alert--warning{background-color:", ";[href]{color:", ";}.k-Alert__iconBadge{background-color:", ";border-color:", ";}.k-Alert__closeButton{svg,svg path{fill:", ";:hover{fill:'#A47600';}}}}&.k-Alert--shouldHide{pointer-events:none;animation:", " 0.4s cubic-bezier(0.895,0.03,0.685,0.22) forwards;}"], (0, _typography.pxToRem)(10), _screenConfig.mq.tabletAndDesktop, (0, _typography.pxToRem)(20), _typographyConfig.default.fontStyles.light, (0, _typography.pxToRem)(10), _colorsConfig.default.primary5, _colorsConfig.default.font1, (0, _typography.pxToRem)(18), (0, _typography.pxToRem)(17), (0, _typography.pxToRem)(30), (0, _typography.stepToRem)(-1), _colorsConfig.default.primary1, _colorsConfig.default.primary4, (0, _typography.pxToRem)(24), (0, _typography.pxToRem)(24), (0, _typography.pxToRem)(17), (0, _typography.pxToRem)(-18), (0, _typography.pxToRem)(18), (0, _typography.pxToRem)(-2), _colorsConfig.default.primary1, _colorsConfig.default.primary3, _typographyConfig.default.fontStyles.bold, _colorsConfig.default.primary1, _colorsConfig.default.tertiary1, _colorsConfig.default.valid, _colorsConfig.default.valid, _colorsConfig.default.tertiary2, _colorsConfig.default.valid, _colorsConfig.default.tertiary2, _colorsConfig.default.error2, _colorsConfig.default.error, _colorsConfig.default.error, _colorsConfig.default.error3, _colorsConfig.default.error, _colorsConfig.default.error4, _colorsConfig.default.warning2, _colorsConfig.default.orange3, _colorsConfig.default.orange3, _colorsConfig.default.orange, _colorsConfig.default.warning, fadeOut);
...
var Alert = function Alert(_ref) {
  var className = _ref.className,
      ...
      center = _ref.center,
      others = (0, _objectWithoutProperties2.default)(_ref, ["className", "show", "error", "success", "warning", "closeButton", "closeButtonLabel", "children", "onAfterClose", "icon", "iconBadgeBorderColor", "center"]);
