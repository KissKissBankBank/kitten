...
var StyledCarouselContainer = _styledComponents.default.div.withConfig({
...
}, (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING_THIN / 2), function (_ref6) {
  ...
  return [].concat(Array(numberOfPages).keys()).map(function (item) {
    return (0, _styledComponents.css)(["&:nth-child(", "){-ms-grid-column:", ";}"], item + 1, item * 2 + 1);
  });
}, (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING_THIN - OUTLINE_PLUS_OFFSET), (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING_THIN - OUTLINE_PLUS_OFFSET), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.S.min), (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING - OUTLINE_PLUS_OFFSET), (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING - OUTLINE_PLUS_OFFSET), (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING_THIN - OUTLINE_PLUS_OFFSET), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.S.min), (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING - OUTLINE_PLUS_OFFSET), function (_ref11) {
  var numberOfItemsPerPage = _ref11.numberOfItemsPerPage;
  return numberOfItemsPerPage;
}, (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING_THIN / 2 - OUTLINE_PLUS_OFFSET * 2), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.S.min), (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING / 2 - OUTLINE_PLUS_OFFSET * 2), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.L.min), function (_ref12) {
  var baseItemMarginBetween = _ref12.baseItemMarginBetween;
  return (0, _typography.pxToRem)(baseItemMarginBetween - OUTLINE_PLUS_OFFSET * 2);
}, (0, _typography.pxToRem)(OUTLINE_PLUS_OFFSET), _colorsConfig.default.primary4, (0, _typography.pxToRem)(2), (0, _typography.pxToRem)(2), _colorsConfig.default.primary4, function (_ref13) {
  var numberOfItemsPerPage = _ref13.numberOfItemsPerPage;
  return numberOfItemsPerPage > 1 ? (0, _styledComponents.css)(["(1fr ", ")[", "] 1fr;"], (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING_THIN / 2), numberOfItemsPerPage - 1) : '1fr';
  ...
  return [].concat(Array(numberOfItemsPerPage).keys()).map(function (item) {
    return (0, _styledComponents.css)(["&:nth-child(", "){-ms-grid-column:", ";}"], item + 1, item * 2 + 1);
  });
});
