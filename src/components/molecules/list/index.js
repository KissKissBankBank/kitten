...
})(["list-style:none;margin:0;padding:0;&.k-List--hasBottomRadius .k-List__item:last-child .k-List__button{border-bottom-left-radius:var(--list-bottomRadiusValue,0);border-bottom-right-radius:var(--list-bottomRadiusValue,0);}.k-List__item{display:flex;gap:", ";align-items:center;&:not(:first-child){margin-bottom:var(--list-gap);}&:not(:last-child){margin-bottom:var(--list-gap);}}.k-List__marker{display:inline-flex;align-items:center;}", ""], (0, _typography.pxToRem)(10), function (_ref) {
