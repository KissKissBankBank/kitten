...
})(["", ";position:relative;overflow:hidden;background-color:", ";color:", ";display:flex;align-items:flex-start;.k-Alert__text{padding:", " ", ";flex:1 0 0;font-size:", ";@media (min-width:", "){text-align:center;}}.k-Alert__button{flex:0 0 auto;transition:all 0.2s ease;svg,svg path{transition:fill 0.2s ease;}&:focus{outline:", " solid ", ";outline-offset:", ";}}a{", ";color:inherit;text-decoration:underline;}&.k-Alert--success{color:", ";background-color:", ";}&.k-Alert--error{color:", ";background-color:", ";}&.k-Alert--warning{color:", ";background-color:", ";}&.k-Alert--hasCloseButton{.k-Alert__text{@media (min-width:", "){margin-left:", ";}}}&.k-Alert--shouldHide{pointer-events:none;animation:", " 0.4s cubic-bezier(0.895,0.03,0.685,0.22) forwards;}"], _typographyConfig.default.fontStyles.light, _colorsConfig.default.primary5, _colorsConfig.default.primary1, (0, _typography.pxToRem)(13), (0, _typography.pxToRem)(20), (0, _typography.stepToRem)(-1), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.S.min), _colorsConfig.default.background1, (0, _typography.pxToRem)(2), (0, _typography.pxToRem)(-4), _typographyConfig.default.fontStyles.bold, _colorsConfig.default.valid, _colorsConfig.default.tertiary1, _colorsConfig.default.error, _colorsConfig.default.error2, _colorsConfig.default.warning, _colorsConfig.default.warning2, (0, _typography.pxToRem)(_screenConfig.ScreenConfig.S.min), (0, _typography.pxToRem)(50), fadeOut);
