...
var StyledCard = _styledComponents.default.a.withConfig({
  ...
  componentId: "sc-uo2adn-0"
})(["border:var(--border-width) solid transparent;background-color:", ";box-sizing:border-box;height:", ";width:100%;padding:", ";display:grid;gap:", " ", ";grid-template-columns:", " ", " 1fr;grid-template-rows:auto repeat(2,1fr);text-decoration:none;color:", ";border-radius:calc(", " + var(--border-width));transition:background-color 0.2s ease,border-color 0.2s ease;&[href]:hover{border-color:var(--color-grey-400);background-color:", ";}&[href]:active{border-color:var(--color-grey-500);background-color:", ";}&[href]:focus-visible{outline:auto;}.k-HorizontalCrowdfundingCard__imageWrapper{grid-column:1 / span 1;grid-row:1 / span 3;img{width:", ";height:", ";object-fit:cover;object-position:center;border-radius:var(--border-radius-xs);}}.k-HorizontalCrowdfundingCard__title{grid-column:2 / span 2;grid-row:1 / 2;margin:0;line-height:1.2;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}.k-HorizontalCrowdfundingCard__description{grid-column:2 / span 2;grid-row:2 / 3;margin:0;line-height:1;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}.k-HorizontalCrowdfundingCard__info{grid-column:2 / span 1;grid-row:3 / 4;}.k-HorizontalCrowdfundingCard__progress{grid-column:3 / span 1;grid-row:3 / 4;place-self:center stretch;display:flex;gap:", ";align-items:center;.k-HorizontalCrowdfundingCard__progress__ramp{flex:1 0 calc(100% - ", ");}.k-HorizontalCrowdfundingCard__progress__value{flex:0 0 ", ";width:", ";}@media (max-width:", "){display:none;}}@media (max-width:", "){&.k-HorizontalCrowdfundingCard--noProgressOnMobile{.k-HorizontalCrowdfundingCard__progress{display:none;}.k-HorizontalCrowdfundingCard__info{grid-column:2 / span 2;}}}"], _colorsConfig.default.background1, (0, _typography.pxToRem)(70), (0, _typography.pxToRem)(4), (0, _typography.pxToRem)(5), (0, _typography.pxToRem)(10), (0, _typography.pxToRem)(100), (0, _typography.pxToRem)(110), _colorsConfig.default.font1, (0, _typography.pxToRem)(4 + 4), _colorsConfig.default.background2, _colorsConfig.default.background3, (0, _typography.pxToRem)(100), (0, _typography.pxToRem)(60), (0, _typography.pxToRem)(5), (0, _typography.pxToRem)(5 + 46), (0, _typography.pxToRem)(46), (0, _typography.pxToRem)(46), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.XXS.max), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.XS.max));
