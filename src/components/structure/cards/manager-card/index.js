...
})(["max-width:100%;position:relative;display:block;box-sizing:border-box;text-decoration:none;background-color:var(--color-grey-000);padding:", " ", " ", " ", ";transition:background-color var(--transition),border-color var(--transition);border:var(--border);border-radius:var(--border-radius-m);display:flex;gap:0 ", ";&.k-ManagerCard--hasAction{&:hover{background-color:var(--color-grey-100);border-color:var(--color-grey-500);}&:active{background-color:var(--color-grey-200);border-color:var(--color-grey-600);}}@media ", "{flex-direction:column;}@media ", "{height:", ";}.k-ManagerCard__action{position:absolute;left:0;right:0;top:0;bottom:0;width:100%;height:100%;border-radius:var(--border-radius-m);cursor:pointer;z-index:1;:focus-visible{outline:auto;}}.k-ManagerCard__cell{flex:1 1 auto;}.k-ManagerCard__lastCell{flex:0 0 auto;z-index:2;display:flex;align-items:stretch;@media ", "{justify-content:flex-end;margin-bottom:", ";margin-right:", ";}@media ", "{justify-content:stretch;margin:", " ", ";}.k-DropdownMenu .k-DropdownMenu__button{box-sizing:border-box;display:flex;justify-content:center;@media ", "{align-items:flex-end;padding:", " ", ";}@media ", "{align-items:center;height:100%;padding:0 ", ";}&:focus-visible .k-DropdownMenu__button__inside{outline:auto;outline-offset:", ";}}}"], (0, _typography.pxToRem)(20), (0, _typography.pxToRem)(30), (0, _typography.pxToRem)(20), (0, _typography.pxToRem)(20), (0, _typography.pxToRem)(10), _screenConfig.mq.mobile, _screenConfig.mq.tabletAndDesktop, (0, _typography.pxToRem)(105), _screenConfig.mq.mq, (0, _typography.pxToRem)(-20), (0, _typography.pxToRem)(-30), _screenConfig.mq.tabletAndDesktop, (0, _typography.pxToRem)(-20), (0, _typography.pxToRem)(-30), _screenConfig.mq.mobile, (0, _typography.pxToRem)(20), (0, _typography.pxToRem)(30), _screenConfig.mq.tabletAndDesktop, (0, _typography.pxToRem)(30), (0, _typography.pxToRem)(-2));
