...
var TagInput = function TagInput(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(StyledWrapper, {
    className: (0, _classnames.default)('k-Form-TagList', className, "k-Form-TagList--" + size, {
