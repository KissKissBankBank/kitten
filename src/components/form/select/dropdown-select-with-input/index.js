...
const DropdownSelectWithInput = _ref => {
  ...
  const onSelectedItemChange = changes => {
    ...
    onInputChange({
      ...
      inputValue: inputEl == null ? void 0 : inputEl.value
    });
  };
  ...
  const onIsOpenChange = changes => {
    if (!changes.isOpen) {
      ...
      inputEl == null ? void 0 : (_inputEl$current = inputEl.current) == null ? void 0 : _inputEl$current.focus();
    }
  };
  ...
  }), isOpen && !deactivateDropdown && options.map((item, index) => {
