...
/*#__PURE__*/
function (_Component) {
  _inherits(TextInputWithUnit, _Component);

  function TextInputWithUnit() {
    _classCallCheck(this, TextInputWithUnit);

    return _possibleConstructorReturn(this, _getPrototypeOf(TextInputWithUnit).apply(this, arguments));
  }
  ...
  _createClass(TextInputWithUnit, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          others = _objectWithoutProperties(_this$props, ["className", "valid", "error", "type", "unit", "unitWord", "tiny", "disabled", "digits"]);
