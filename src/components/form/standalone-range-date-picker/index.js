...
})(["--rdp-cell-size:", ";--rdp-accent-color:var(--color-primary-500);--rdp-background-color:var(--color-grey-000);--rdp-outline:", " solid var(--rdp-accent-color);--rdp-outline-selected:", " solid rgba(0,0,0,0.75);", " .rdp-caption_label{", " font-size:", ";}.rdp-head_cell{", " font-size:", ";text-transform:capitalize;}.rdp-cell{font-size:", ";}.rdp-button{transition:color var(--transition),background-color var(--transition),border-color var(--transition);}.rdp-day_range_start,.rdp-day_range_end{", "}.rdp-day_range_middle{background-color:var(--color-primary-100);color:var(--color-primary-700);}"], (0, _typography.pxToRem)(50), (0, _typography.pxToRem)(2), (0, _typography.pxToRem)(2), _typographyConfig.default.fontStyles[400], _typographyConfig.default.fontStyles[500], (0, _typography.pxToRem)(14), _typographyConfig.default.fontStyles[500], (0, _typography.pxToRem)(12), (0, _typography.pxToRem)(12), _typographyConfig.default.fontStyles[700]);
