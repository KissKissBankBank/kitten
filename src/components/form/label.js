...
function (_Component) {
  ...
  _createClass(Label, [{
    ...
    value: function render() {
      ...
      var Tag = tag;
      var labelClassName = (0, _classnames.default)('k-Label', className, (_classNames = {}, _defineProperty(_classNames, "k-Label--".concat(size), size), _defineProperty(_classNames, 'k-Label--withoutPointerEvents', withoutPointerEvents), _classNames));
