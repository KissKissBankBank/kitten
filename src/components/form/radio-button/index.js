...
var _excluded = ["className", "id", "children", "inputClassName", "large", "largeContent", "size", "text", "error", "disabled", "design", "fontWeight", "weight", "paragraphStyle"];
...
var RadioButton = function RadioButton(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(StyledRadioButton, {
    className: (0, _classnames.default)('k-Form-RadioButton', className, "k-Form-RadioButton--" + design, "k-Form-RadioButton--" + size, "k-Form-RadioButton__labelText--" + (fontWeight || weight), {
