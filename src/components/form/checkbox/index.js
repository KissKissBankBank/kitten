...
var Checkbox = function Checkbox(_ref) {
  var className = _ref.className,
      ...
      label = _ref.label,
      inputProps = (0, _objectWithoutProperties2.default)(_ref, ["className", "id", "children", "inputClassName", "error", "disabled", "textProps", "onLabelClick", "indeterminate", "label"]);
  ...
  return /*#__PURE__*/_react.default.createElement(StyledCheckbox, {
    className: (0, _classnames.default)('k-Form-Checkbox', className, {
