...
function (_React$Component) {
  ...
  function RadioButtonSet(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(RadioButtonSet).call(this, props));
    _this.renderRadioButton = _this.renderRadioButton.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
