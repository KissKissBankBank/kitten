...
/*#__PURE__*/
function (_Component) {
  _inherits(TextInputWithButton, _Component);

  function TextInputWithButton() {
    _classCallCheck(this, TextInputWithButton);

    return _possibleConstructorReturn(this, _getPrototypeOf(TextInputWithButton).apply(this, arguments));
  }
  ...
  _createClass(TextInputWithButton, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          others = _objectWithoutProperties(_this$props, ["valid", "error", "disabled", "value", "className", "textInputProps", "buttonProps"]);
      ...
      }, others), _react.default.createElement(_textInput.TextInput, _extends({}, textInputProps, {
        valid: valid,
        error: error,
        disabled: disabled,
