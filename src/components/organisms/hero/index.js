...
var StyledHero = (0, _styledComponents.default)(function (_ref) {
  ...
  return backgroundColor;
}, (0, _typography.pxToRem)(_screenConfig.ScreenConfig.M.max), (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING * 2), (0, _typography.pxToRem)(-_gridConfig.CONTAINER_PADDING), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.XS.max), (0, _typography.pxToRem)(_gridConfig.CONTAINER_PADDING_THIN * 2), (0, _typography.pxToRem)(-_gridConfig.CONTAINER_PADDING_THIN), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.M.max), 8 / _gridConfig.NUM_COLUMNS * 100 + 'vw', (0, _typography.pxToRem)(_screenConfig.ScreenConfig.XS.max), (0, _typography.pxToRem)(-_gridConfig.CONTAINER_PADDING_THIN), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.M.max), 10 / _gridConfig.NUM_COLUMNS * 100 + '%', (0, _typography.pxToRem)(_screenConfig.ScreenConfig.XS.max), 5 / _gridConfig.NUM_COLUMNS * 100 + '%', (0, _typography.pxToRem)(_screenConfig.ScreenConfig.M.max), 8 / _gridConfig.NUM_COLUMNS * 100 + 'vw', 2 / _gridConfig.NUM_COLUMNS * 100 + '%', (0, _typography.pxToRem)(_screenConfig.ScreenConfig.XS.max), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.XS.max), (0, _typography.pxToRem)(-_gridConfig.CONTAINER_PADDING_THIN), 11 / _gridConfig.NUM_COLUMNS * 100 + '%', (0, _typography.pxToRem)(_screenConfig.ScreenConfig.M.max), 12 / _gridConfig.NUM_COLUMNS * 100 + '%', (0, _typography.pxToRem)(_screenConfig.ScreenConfig.XS.max), (0, _typography.pxToRem)(-_gridConfig.CONTAINER_PADDING / 2), (0, _typography.pxToRem)(_screenConfig.ScreenConfig.L.min), 1 / 2 / _gridConfig.NUM_COLUMNS * 100 + 'vw');
