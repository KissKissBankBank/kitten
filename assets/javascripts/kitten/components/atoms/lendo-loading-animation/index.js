...
export const LendoLoadingAnimation = props => (
  ...
  >
    ...
    <g mask="url(#mask)">
      ...
      <g id="col_1" className="animated_col">
        <path
      ...
      <g id="col_2" className="animated_col">
        <path
      ...
      <g id="col_3" className="animated_col">
        <path
      ...
      <g id="col_7" className="animated_col">
        <path
      ...
      <g id="col_6" className="animated_col">
        <path
      ...
      <g id="col_5" className="animated_col">
        <path
      ...
      <g id="col_4" className="animated_col">
        <path
