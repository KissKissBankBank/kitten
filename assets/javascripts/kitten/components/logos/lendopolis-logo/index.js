...
export const LendopolisLogo = ({
  ...
  return (
    ...
    >
      ...
      <circle fill="#fff" cx="13.88" cy="13.76" r="13.61" />
      <path
        fill={secondaryColor}
