  ...
  <StyledWrapper className={`size-${args.size}`}>
    ...
    <RichText {...args}>
      ...
      <p>
        ...
        <em>Sed posuere consectetur est at lobortis.</em> Cras justo odio,
      ...
      <p>
        ...
        <a href="https://www.kisskissbankbank.com">
        ...
        augue laoreet rutrum faucibus dolor auctor. Fusce dapibus, tellus ac
        cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo
        sit amet risus. Fusce dapibus, tellus ac cursus commodo, tortor mauris
        condimentum nibh, ut fermentum massa justo sit amet risus. Donec id elit
        non mi porta gravida at eget metus. Nullam quis risus eget urna mollis
        ornare vel eu leo.
      </p>
      <img src="/kitten-0.jpg" alt="" />
      <p className="k-RichText--align-center">
        <em>Un petit chat bien mignon !</em>
      </p>
      ...
      <p>
        ...
        ultricies vehicula ut id elit. Donec sed odio dui. Nulla vitae elit
        libero, a pharetra augue. Morbi leo risus, porta ac consectetur ac,
        vestibulum at eros.
      </p>
      <ul>
        <li>
          <strong>Vivamus sagittis lacus vel augue</strong> laoreet rutrum
          faucibus dolor auctor.
        </li>
        <li>
          <strong>Cum sociis natoque penatibus</strong> et magnis dis parturient
          montes, nascetur ridiculus mus.
        </li>
        <li>
          <strong>Sed posuere.</strong>
        </li>
        <li>
          <strong>Cras mattis.</strong>
        </li>
      </ul>
      <p>
        Etiam porta sem malesuada magna mollis euismod. Maecenas sed diam eget
      ...
      <p>
        ...
        mollis interdum. Nulla vitae elit libero, a pharetra augue. Morbi leo
        risus, porta ac consectetur ac, vestibulum at eros. Integer posuere erat
        a ante venenatis dapibus posuere velit aliquet. Nulla vitae elit libero,
        a pharetra augue.
      </p>
      <p>
        ...
        dapibus posuere velit aliquet. Lorem ipsum dolor sit amet, consectetur
        adipiscing elit.
      </p>
