...
<Meta title="Molecules/Buttons/Button" component={Button} />

# Buttons

## Source

<FileUrl filepath={__filename} filenames={['index.js', 'helpers/modifier-styles.js']} />
...
<Button modifier="iron">MyButton</Button>
```
...
<Canvas>
  <Story name="WithColorIcon" story={stories.WithColorIcon} />
</Canvas>
